...
public class AdminActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verObjetos = (RecyclerView) findViewById(R.id.verObjetos);
        ...
        verObjetos.setLayoutManager(new LinearLayoutManager(this));
        verObjetos.setLayoutManager(new GridLayoutManager(this, 2));
        verObjetos.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
